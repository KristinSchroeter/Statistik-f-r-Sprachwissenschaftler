...
Welches Format ergibt am ehesten Sinn?
...
### By Item
Bei "Item" berechnen wir die Mittelwerte aller Trials innerhalb eines Items, d.h. wir nehmen den itemweise Mittelwert über Versuchspersonen hinweg. Dafür können wir `aggregate()` nutzen.
...
Sie fragen sich evtl, woher der weitere Faktor `(Intercept)` kommt. Intercept ist der *Abschnitt* und beschreibt, wie weit weg die Basis des Models von Null ist -- hier ist sie ziemlich weit weg von Null, was Sinn ergibt, weil niemand eine Reaktionszeit von Null hat! 
...
# Lizenz
Dieses Werk darf nur für Prüfungszwecke dienen.
