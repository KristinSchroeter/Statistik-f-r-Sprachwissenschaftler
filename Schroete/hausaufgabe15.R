...
# 2014-06-09
# Diese Datzei darf nur Prüfungszwecken dienen.
...
# Die Plots sehen gleich aus.
# R^2-Wert und t-werte sind gleich.
# Die Koeffizienten sind unterschiedlich.
...
# R^2-Wert hat sich nicht geändert.
# t-Werte und Koeffizienten sind unterschiedlich.
...
# Dieser Datensatz gibt die Durchschnittsgrößen sowie -gewichte an.
# Es handelt sich also schon um Mittelwerte von US-Frauen zwischen 30 und 39.
# In unserem Datensatz waren es zufällige Rohdaten aus unserem Kurs mit beiden Geschlechtern.
