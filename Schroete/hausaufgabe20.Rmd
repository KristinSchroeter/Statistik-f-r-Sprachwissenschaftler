...
Wir können auf ähnliche Art und Weise einen Plot für die Versuchspersonen und Szenarien erstellen.
...
Um die Berechnung im folgenden zu beschleunigen, bleiben wir momentan bei einer Intercepts-Only-RE-Struktur. Weil der Effekt von Geschlecht schon aus der Literatur und dem Alltag bekannt ist, nehmen wir das Modell nur mit `gender` als Ausgangspunkt. Wir haben auch vor, Modellvergleiche zu machen, daher setzen wir `REML=FALSE` von Anfang an.
