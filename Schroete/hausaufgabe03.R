...
# Häufigkeiten entstehen: tabelle.prozent <- tabelle.rel *100
...
# wenn es mehrere Elemente mit der gleichen Anzahl gibt,
# werden diese alle angezeigt,
# aber der Code in diesem Fall ist korrekt,
# weil es hier nur zwei Elemente gibt.
